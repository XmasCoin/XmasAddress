ninja.translator = {
	...
	translations: {
		...
		"es": {
			...
			"singletip1": "<b>A Catcoin wallet</b> is as simple as a single pairing of a Catcoin address with its corresponding Catcoin private key. Such a wallet has been generated for you in your web browser and is displayed above.", //TODO: please translate
			"singletip2": "<b>To safeguard this wallet</b> you must print or otherwise record the Catcoin address and private key. It is important to make a backup copy of the private key and store it in a safe location. This site does not have knowledge of your private key. If you are familiar with PGP you can download this all-in-one HTML page and check that you have an authentic version from the author of this site by matching the SHA1 hash of this HTML with the SHA1 hash available in the signed version history document linked on the footer of this site. If you leave/refresh the site or press the \"Generate New Address\" button then a new private key will be generated and the previously displayed private key will not be retrievable.	Your Catcoin private key should be kept a secret. Whomever you share the private key with has access to spend all the catcoins associated with that address. If you print your wallet then store it in a zip lock bag to keep it safe from water. Treat a paper wallet like cash.", //TODO: please translate
			...
			"singletip4": "<b>Check your balance</b> by going to <a href=\"http://catchain.info\" target=\"_blank\">Catchain.info</a> and entering your Catcoin address.", //TODO: please translate
			"singletip5": "<b>Spend your catcoins</b> by downloading Catcoin-Qt from <a href=\"http://catcoins.biz\" target=\"_blank\">http://catcoins.biz</a> and importing your private key into the application. Keep in mind when you import your single key and spend funds with Catcoin-Qt, your key will be bundled with other private keys in the wallet. When you perform a transaction, your change will be sent to another Catcoin address within Catcoin-Qt. You must then backup Catcoin-Qt and keep the data safe, as your remaining catcoins will be stored there, not just at your original address. Satoshi advised that one should never delete a wallet.", //TODO: please translate
			...
			"bulka1": "La forma tradicional de aceptar catcoins en tu web requiere tener instalado el cliente oficial de Catcoin (\"catcoind\"). Sin embargo muchos servicios de hosting no permiten instalar dicho cliente. Además, ejecutar el cliente en tu servidor supone que las claves privadas están también en el servidor y podrían ser comprometidas en caso de intrusión. Al usar este mecanismo, puedes subir al servidor sólo las dirección de Catcoin y no las claves privadas. De esta forma no te tienes que preocupar de que alguien robe la cartera si se cuelan en el servidor.",
			...
			"bulklabela2li4": "Ahora te hace falta recibir una notificación del pago. Busca en google \"notificación de pagos Citecoin\" (o \"Citecoin payment notification\" en inglés) y suscríbete a alguno de los servicios que aparezcan. Hay varios de ellos, que te pueden notificar vía Web services, API, SMS, email, etc. Una vez te llegue la notificación, lo cual puede ser automatizado, entonces ya puedes procesar el pedido. Para comprobar a mano si has recibido un pago, puedes usar Block Explorer: reemplaza DIRECCION a continuación por la dirección que estés comprobando. La transacción puede tardar entre 10 minutos y una hora en ser confirmada. <br />http://catchain.info.com/address/DIRECCION<br /><br />Puedes ver las transacciones sin confirmar en: http://catchain.info/ <br />Las transacciones sin confirmar suelen aparecer ahí en unos 30 segundos.",
		...
		"fr": {
			...
			"detaillabelnote1": "Votre Clé Privée Catcoin est un nombre secret que vous êtes le seul à connaître. Il peut être encodé sous la forme d'un nombre sous différents formats. Ci-bas, nous affichons l'adresse Catcoin et la Clé Publique qui corresponds à la Clé Privée ainsi que la Clé Privée dans les formats d'encodage les plus populaires (WIF, HEX, B64, MINI).",
		...
		"el": {
			...
			"brainalertpassphrasewarning": "Προσοχή: Είναι σημαντικό να επιλέξετε μια ισχυρή φράση κωδικό που θα σας προφυλάξει από απόπειρες παραβίασής της τύπου brute force και κλοπή των catcoins σας.",
			...
			"bulka1": "Ο παραδοσιακός τρόπος για να δέχεστε catcoins στην ιστοσελίδα σας, απαιτεί την εγκατάσταση και λειτουργία του επίσημου δαίμονα πελάτη Catcoin (\"catcoind\"). Αρκετά πακέτα φιλοξενίας δεν υποστηρίζουν την εγκατάστασή του. Επιπλέον, η εκτέλεση του πελάτη Catcoin στον web server σας συνεπάγεται και τη φιλοξενία των προσωπικών σας κλειδιών στον ίδιο server, τα οποία μπορεί να υποκλαπούν αν ο server πέσει θύμα επίθεσης. Χρησιμοποιώντας τα Πολλαπλά Πορτοφόλια, ανεβάζετε στον server σας μόνο τις διευθύνσεις Catcoin κι όχι τα προσωπικά κλειδιά. Με αυτό τον τρόπο δεν χρειάζεται να ανησυχείτε μήπως υποκλαπεί το πορτοφόλι σας.",
			"bulklabelq2": "Πως χρησιμοποιώ τα Πολλαπλά Πορτοφόλια για να δέχομαι catcoins στην ιστοσελίδα μου;",
